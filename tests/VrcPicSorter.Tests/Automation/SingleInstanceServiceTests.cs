...
public sealed class SingleInstanceServiceTests
{
    ...
    public void SecondInstanceSignalsOwningInstance()
    {
        ...
        using var owner = new SingleInstanceService("VrcPicSorter.Tests", testScope);
        ...
        var contenderThread = new Thread(
            () =>
            {
                try
                {
                    using var contender = new SingleInstanceService("VrcPicSorter.Tests", testScope);
    ...
    public void AbandonedMutexAllowsCleanOwnershipRecovery()
    {
        ...
        var ownerThread = new Thread(
            () =>
            {
                try
                {
                    abandoned = new SingleInstanceService("VrcPicSorter.Tests", testScope);
        ...
        using (var recovered = new SingleInstanceService("VrcPicSorter.Tests", testScope))
        {
